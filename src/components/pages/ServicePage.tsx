    ...
    <div className={styles.page}>
      <section className={styles.pageHero}>
        ...
        <div className="container">
          <p className={styles.pageLabel}>SERVICE</p>
          <h1 className={styles.pageTitle}>EC支援アプリの開発・提供</h1>
          <p className={styles.pageDesc}>
            自社アプリの提供と、事業者さまごとの課題に応じたカスタムアプリ開発の両方を行っています。
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <article className={`${styles.serviceBlock} glass-panel reveal`}>
            <div className={styles.serviceHeader}>
              ...
              <div>
                <p className={styles.serviceEyebrow}>現場の課題から生まれる自社プロダクト</p>
            ...
            <div className={styles.productCard}>
              <div className={styles.productHeader}>
                ...
                <div className={styles.productInfo}>
                  ...
                  <h3 className={styles.productName}>Fラベル｜EC用の食品表示</h3>
          ...
          <article className={`${styles.serviceBlock} glass-panel reveal`}>
            <div className={styles.serviceHeader}>
              ...
              <div>
                <p className={styles.serviceEyebrow}>運用に合わせて設計する個別開発</p>
                <h2 className={styles.serviceTitle}>Shopifyカスタムアプリ開発</h2>
              </div>
            </div>
            <p className={styles.serviceDesc}>
